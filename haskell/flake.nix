      ...
      haskellSourceFilter =
        ...
        nixpkgs.lib.cleanSourceWith {
          ...
          filter =
            ...
            && !(baseName == "dist-newstyle" || nixpkgs.lib.hasPrefix "." baseName);
        };

      # The package derivation:
      derivation =
        haskell: haskell.callCabal2nix packageName (haskellSourceFilter ./.) (packageOverrides haskell);
    in
    {
